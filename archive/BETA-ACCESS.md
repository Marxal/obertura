> **ARCHIVED 2026-09.** The beta gate was removed when Bito Chess went public
> at bitochess.com: a client-side SHA-256 check was always a friendly speed bump
> rather than security, and once the app was public it guarded nothing while
> still standing between every fresh browser and the app. `src/gate.ts` now
> keeps only the PWA install-prompt plumbing. Nothing below describes today's
> code — it is kept because the codes and the reasoning were real at the time.
