...
export class EvalPanel {
  ...
  private build() {
    ...
    this.controlsEl.innerHTML = `
      <div class="eval-row">
        ...
        <div class="eval-right">
          ...
          <button type="button" class="watch-speed-btn" id="watch-speed-btn" aria-label="Playback speed" title="Playback speed">Normal</button>
    ...
    this.controlsEl.querySelector<HTMLButtonElement>('#board-flip')!
      .addEventListener('click', () => this.onFlip());
