...
export const PUZZLE_THEME_GROUPS: PuzzleThemeGroup[] = [
  ...
  },
  {
    id: 'mate-patterns',
    label: 'Mate patterns',
    blurb: 'Classic mates to know by sight',
  ...
  },
  {
    ...
    blurb: 'Forks, pins, skewers and more',
  ...
  },
  {
    id: 'length',
    label: 'Puzzle length',
    blurb: 'From one-movers to deep lines',
    icon: () => Icons.order(16),
    themes: [
  ...
  },
  {
    id: 'goals',
    label: 'Goals',
    blurb: 'From equalising to mating',
    icon: () => Icons.flag(16),
    themes: [
