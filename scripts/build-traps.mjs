...
const PACKS = [
  {
    ...
    traps: [
      ...
      {
        name: 'Légal Trap (Philidor)',
        level: 'Intermediate',
        family: 'Philidor Defense',
        bait: '…Bxd1 (grabbing the queen)',
        idea: 'The original Légal setting: 5.Nxe5! and if 5…Bxd1?? 6.Bxf7+ Ke7 7.Nd5# — the two knights and the bishop weave a mating net.',
        sans: ['e4','e5','Nf3','d6','Bc4','Bg4','Nc3','g6','Nxe5','Bxd1','Bxf7+','Ke7','Nd5#'],
      },
      {
        name: 'Rubinstein Trap (Queen’s Gambit Declined)',
        level: 'Advanced',
        family: "Queen's Gambit",
        bait: '…b6 (a natural-looking fianchetto)',
        idea: 'The f6-knight is pinned to the queen, so 8.cxd5 exd5 9.Nxd5! wins a pawn — 9…Nxd5 10.Bxe7 then nets the bishop and the pawn.',
        sans: ['d4','d5','c4','e6','Nc3','Nf6','Bg5','Nbd7','e3','Be7','Nf3','O-O','Rc1','b6','cxd5','exd5','Nxd5'],
      },
    ],
  },
  {
    ...
    traps: [
      ...
      },
      {
        ...
        level: 'Intermediate',
        family: 'Italian Game',
        bait: '4.Nxe5?? (winning the e5-pawn)',
        idea: 'The cheeky 3…Nd4 sets it: 4.Nxe5?? Qg5! 5.Nxf7 Qxg2 6.Rf1 Qxe4+ 7.Be2 Nf3# — the pinned e2-bishop can’t capture the mating knight.',
      ...
      },
      {
        ...
        level: 'Advanced',
        family: "Queen's Gambit",
        bait: '7.Bd3?? (developing into the pin)',
        idea: 'Cambridge Springs: 7…dxc4 8.Bxc4 Ne4! forks the pinned c3-knight (held by …Qa5) and the g5-bishop, and wins a piece.',
        sans: ['d4','d5','c4','e6','Nc3','Nf6','Bg5','Nbd7','e3','c6','Nf3','Qa5','Bd3','dxc4','Bxc4','Ne4'],
      },
    ],
  },
];
